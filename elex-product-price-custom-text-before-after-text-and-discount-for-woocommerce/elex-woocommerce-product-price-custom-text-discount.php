...
$ppct_plugins        = array(
	...
	'elex-before-after-text-premium/product-price-custom-text-discount-premium.php' => "Premium Version of Elex Product Price Custom Text Before After Text And Discount Plugin is installed. Please deactivate the Premium Version of Elex Product Price Custom Text Before After Text And Discount before activating Basic version.<br>Don't worry! Your data will be retained.<br>Go back to <a href='" . esc_html( admin_url( 'plugins.php' ) ) . "'>plugins page</a>",
