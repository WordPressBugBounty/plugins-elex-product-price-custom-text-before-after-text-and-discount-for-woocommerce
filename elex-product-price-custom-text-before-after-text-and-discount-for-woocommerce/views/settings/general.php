							...
							<td class="forminp elex_ppct_page_td" id="elex_ppct_page_td_id">
								<div >
									...
									<ul class="elex_pages" id="elex_ppct_pages" >
										...
										<li><input class="elex_ppct_page_type" name="elex_custom_text_selected_pages[]" type="checkbox" value="checkout_page"
												<?php esc_attr_e( ( empty( $selected_pages ) ) ? '' : ( ( in_array( 'checkout_page', $selected_pages ) ) ? 'checked' : '' ) ); ?>>
											<?php esc_attr_e( 'Checkout Page', 'elex-product-price-custom-text-and-discount' ); ?>
										</li>
									</ul>    
								</div>
							</td>
